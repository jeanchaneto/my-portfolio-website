...
const Menu = () => {
  ...
  return (
    <div className="mx-auto max-w-fit rounded-2xl  backdrop-blur-2xl border border-white/10 px-4  fixed bottom-2 left-1/2 -translate-x-1/2 z-50 lg:hidden">
      {/* Opened Menu */}
      ...
      <div className="  h-16 items-center gap-4  flex justify-center ">
        <div className="aspect-square w-10 rounded-xl bg-gradient-radial from-cyan-800/40 to-transparent  backdrop-blur-2xl border-white/10 border relative group ">
          <Link
            href="/"
          ...
          {pathname === "/" && (
            <div className="w-1 h-1 bg-cyan-200 rounded-full absolute right-1/2 translate-x-1/2 -bottom-2" />
          )}
