...
const experiences = [
  {
    title: "Co-Founder and Director at",
    company: "Legionella Logbook",
    companyLink: "https://legionellalogbook.com/",
    timePeriod: "January 2025 - Present",
    content: [
      "Built Legionella Logbook end-to-end: a complete SaaS platform with web and mobile applications designed to modernise the water safety industry.",
      "Single-handedly designed and developed the entire platform (front-end, back-end, mobile app).",
      "Identified critical market gap and transformed it into a user-centric digital solution.",
      "Focused on delivering exceptional user experience and modern design in an industry traditionally reliant on paper-based systems.",
      "Managed full product lifecycle from concept to production deployment.",
    ],
  },
  {
    title: "Front End Developper at",
    company: "Ava Softs & Services",
    companyLink: "https://ava-funeraire.fr/",
    timePeriod: "March 2023 - Present",
    content: [
      "Primarily worked with React and React Native to build sophisticated and engaging applications across web and mobile platforms. Developed complex applications integrating Google Maps API for location-based features and real-time data visualisation. Leveraged a modern tech stack including shadcn/ui component library and Tailwind CSS to create visually impressive, highly performant user interfaces with seamless user experiences. ",
    ],
  },
  {
