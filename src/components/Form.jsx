          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <motion.input
                ...
                className="block w-full appearance-none rounded-md border-0 bg-gray-900/40 px-3.5 py-2 text-gray-100 shadow-sm ring-1 ring-inset ring-white/20 focus:ring-sky-500 sm:text-sm sm:leading-6 focus:outline-none origin-left "
                required
              />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <motion.input
                ...
                id="email"
                autoComplete="email"
                className="block w-full rounded-md border-0 bg-gray-900/40 px-3.5 py-2 text-gray-100 shadow-sm ring-1 ring-inset ring-white/20 focus:ring-sky-500 sm:text-sm sm:leading-6 focus:outline-none origin-left "
                required
              />
            </div>
          </div>
